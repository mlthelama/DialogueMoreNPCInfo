...
namespace scaleform {
    ...
    private:
        ...
        [[nodiscard]] RE::GFxValue build_gfx_value_pair(const std::string_view& a_key,            const std::string_view& a_value) const;
        
        [[nodiscard]] RE::GFxValue build_gfx_value_pair_with_max(const std::string_view& a_key,            const std::string_view& a_value,            const std::string_view& a_max);
